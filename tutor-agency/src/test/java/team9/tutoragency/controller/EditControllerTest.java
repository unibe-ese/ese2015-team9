...
//        Mockito.doNothing().when(memberService).saveEditChange(any(Member.class), captor.capture());
	}
	@Test
    ...
    /**
     * Test of saveChange method, of class {@link EditController}, when errors are present.
     */
    @Test
    ...
    /**
     * Test of saveChange method, of class {@link EditController}, when no errors are present.
     */
    @Test
