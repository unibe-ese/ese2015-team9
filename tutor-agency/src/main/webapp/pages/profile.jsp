...
<div class="container" >
        ...
        <br />
        <table class="forms">
        <tr><td class="profil"><img src="img/profil.png" /></td><td>
        <table class="forms">
        <tr><td style="width:150px"><strong>Vorname:</strong></td><td>${member.firstName}</td></tr>
        <tr><td><strong>Nachname:</strong></td><td>${member.lastName}</td></tr>
        <tr><td><strong>Nickname:</strong></td><td>${member.username}</td></tr>
        <tr><td><strong>e-Mail:</strong></td><td>${member.email}</td></tr>
        </table>
        </td></tr></table>
    ...
    <div class="sidebar">
        ...
        <br />
        <br /><a href="profil.html">Profil ansehen</a>
        <br /><a href="edit.html">Profil bearbeiten</a>
        <br /><a href="tutor.html">Tutor werden</a>
        <br /><a href="logout.html">Logout</a>
        <br />
        <br />
        <br /><a href="delete.html">Profil löschen</a>
    </div>
    <div class="footer">
